...
def parse_args():
    ...
    parse.add_argument('--checkpoint_path', required=True, type=str, help='path to checkpoint of best epoch from training')  
...
if __name__ == "__main__":
    ...
    adata = sc.read(args_test.input_data)

    sc.pp.normalize_total(adata)
    sc.pp.log1p(adata)


    print(f" STARTING TESTING FOR FOLD {args_test.split_key}")
    ...
    Trainer.test(args_test.checkpoint_path)
